				...
				<div class="row">
					<div class="col-md-9">
						<div class="row">
                            ...
                            <div class="room-img" style="background-image: url(ui/frontend/images/thailand/phang.png);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Phang Nga Bay</h2>
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
						<div class="room-img" style="background-image: url(ui/frontend/images/thailand/kophi.png);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Phi Phi Island</h2>
															<p>Phi Phi Island is Thailand's island-superstar. It's been in the movies. It's the topic of conversation for travelers all over Thailand. For some, it's the only reason to touchdown in Phuket. Even with all the hype, it doesn't disappoint. Phi Phi's beauty is a large chunk of the allure. The islands, when approached by boat, rise from the sea like a fortress. Sheer cliffs tower overhead, then give way to beach-fronted jungle. It's love at first sight.
                               </p>
														</div>
													</div>
												</div>
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/grand.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Grand Palace</h2>
															<p>
                                Grand Palace is undoubtedly the most famous landmark in Bangkok. It’s one must-see sight that no visit to the city would be complete without. It was built in 1782 and for 150 years was the home of the Thai King, the Royal court and the administrative seat of government.<br><br>
                                Grand Palace is 1.7 km away from Bangkok.
                              </p>
														</div>
													</div>
												</div>
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/railway.png);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Railay</h2>
															<p>
                                It is, in fact, a small peninsula which counts four beaches. Now on every savvy traveller's list, Railay is nevertheless one of Thailand's most sought-after beach areas. Just south of Ao Nang Beach, around a rocky headland and accessible only by boat, Railay presents a tranquil and extraordinary world.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/phanum.png);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Phanom Rung</h2>
															<p>
                                About 8km down below is the wonderful but often overlooked Prasat Muang Tam ('Lower City Temple'), which is also part of the historical park. It's smaller and less complete, but the peaceful setting – you'll often have it to yourself – and unique design make many people prefer it over its more famous neighbour.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/khaosak.png);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Khao Sok</h2>
                                ...
                                The main attractions of the park are Cheow Lan Lake, iconic limestone hills, waterfalls, raft houses spread over the lae, trails, caves and rivers.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/wat.png);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Wat Traimit</h2>
                                ...
                                Wat Traimit in Bangkok is known for housing a 5.5-tonne statue of a seated Buddha. The gold sculpture dates back to the 13th century and measures at nearly 5 metres in height. Located in Chinatown Bangkok, this ornate temple is about 450 metres west of the Hualampong Railway Station.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/doi.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Doi Inthanon</h2>
                                ...
                                Wat Traimit in Bangkok is known for housing a 5.5-tonne statue of a seated Buddha. The gold sculpture dates back to the 13th century and measures at nearly 5 metres in height. Located in Chinatown Bangkok, this ornate temple is about 450 metres west of the Hualampong Railway Station.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/angthong.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Ang Thong National Marine Park</h2>
															<p>
                                Ang Thong National Marine Park is a fascinating archipelago of 42 or so islands in the Central Gulf Coast of Southern Thailand. It is northwest of Koh Samui Most of the islands are close to each other, making a breathtaking panorama when sailing around the park. All the islands are of different sizes and shapes. Most of them are covered with tropical forests and named after their distinguishing geography, a kind of descriptive appellation, such as 'Sleeping Cow Island' and 'Three Pillars Island'.
                              </p>
														</div>
													</div>
												</div>
                                ...
                                Some of Southeast Asia’s biggest aquariums, SEA LIFE® Bangkok Ocean World is home to more than 400 marine and freshwater species, from tropical fish to otters. Visitors can explore the interactive themed areas, including a Shark Walk and penguin-filled Antarctic zone, and enjoy family-friendly marine activities and 4D movies.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/thailand/zoo1.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Sriracha Tiger Zoo</h2>
															<p>
                                Make new and exciting memories when you visit you the Sriracha Tiger Zoo in Pattaya! Ready your travel essentials and bring the whole squad with you to explore the biggest tiger zoo in Asia that holds over 300 Panthera Tigris and nearly 100,000 species of crocodiles. Not only that, you will also get to see various kinds of animals harmoniously living together in one place, witness pigs interacting with tiger cubs, crocodiles ‘performing’ in their show, baby goats running around, and various kinds of exotic animals like kangaroos, jump back camels, ostriches, and more frolicking all over Sriracha. 
                              </p>
														</div>
													</div>
												</div>
