				...
				<div class="row">
					<div class="col-md-9">
						<div class="row">
                            ...
                            <div class="room-img" style="background-image: url(ui/frontend/images/sylhet/ratargul.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
                                ...
                                It is called the Amazan of Bangladesh. It is about 26 km away from Sylhet city and situated on the border area of Shylet under the Goain ghat area. Goain river flows in north, large hoar in south. And between this two is Ratargul swamp forest. Ratargul swamp forest is one of the most beautiful tourist spot/place in Sylhet.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
						<div class="room-img" style="background-image: url(ui/frontend/images/sylhet/lalakhal.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Lalakhal</h2>
															<p>
                                The part of lalakhal near Tamabil Road name Shari River. The most attractive and interesting thing of this river is various color of water. Water of different part of this river be different such as 
                                blue, green and crystal. You can reach Lalakhal by boat or speed boat on the crystal water of Shari
                                River. Oh! How crystal the water of Shari, you can see the bottom of the river. 
                                You can never back your eyes from this unimaginable scene. Beautiful Lalakhal is 
                                more beautiful at night. As there has no resident to stay for tourist, so you have
                                to back Sylhet before night. But you can hire a boat to hangout. 
                                The surrounding of Lalakhal in twilight is so much lovely.
                                The part of lalakhal near Tamabil Road name Shari River. 
                                The most attractive and interesting thing of this river is various color of water.
                                
                                Beautiful Lalakhal is more beautiful at night. 
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/sylhet/jaflong.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Panthumai</h2>
															<p>
                                It is named from a nearby village -Panthumai. From district headquarter you have to go to Gowainghat sub division from where its about 10 kilometer is the village. Falls is visible from zero point but not accessible from Bangladesh side. So it is better to visit from Indian side.. It is named from a nearby village -Panthumai. From district headquarter you have to go to Gowainghat sub division from where its about 10 kilometer is the village. Falls is visible from zero point but not accessible from Bangladesh side. So it is better to visit from Indian side.
                              </p>
														</div>
													</div>
												</div>
                                ...
                                And flowing underneath towards Bholaganj is a branch of the Piyain. Along the stream flowing from high up in the mountain come huge boulders that are deposited and mined in Bisnakandi.Adding to its charm are dark clouds hugging the mountain in the rainy season. And flowing underneath towards Bholaganj is a branch of the Piyain. Along the stream flowing from high up in the mountain come huge boulders that are deposited and mined in Bisnakandi.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/sylhet/bholagonj.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Bholagonj</h2>
                                ...
                                From May to October, it is time to go to Bholganj white stone area.
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/sylhet/lovachara.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Lovachora</h2>
                                ...
                                <br><br>
                                Lovachora is 67.1km away from the Sylhet city.
                              </p>
														</div>
													</div>
												</div>
										...
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url(ui/frontend/images/sylhet/khadimnagar.jpg);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Khadimnagar Rain Forest</h2>
															<p>
                                The forest is quite popular with trekkers with a 45-minute trail and a two-hour one. There is a map of the trails in front of the local forest office. Besides, trekkers can also hire a local guide. The rainforest boasts of diverse flora and fauna. There are 217 species of plants and trees. Most notable among them are teakwood (tectona grandis) and mahogany (swietenia mahagon) as well as different types of bamboos and canes. Among the animals and birds are different species of bears, wild cats, apes, pythons, parakeets and doves.
                                <br><br>
                                Khadimnagar Rain forest is 10 km away from the Sylhet city.
                              </p>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Jaflong</h2>
															<p>
                                Despite the loss of its former splendour due to unrestricted mining and crushing of stones, Jaflong is still a ‘must-see’ destination for tourists visiting Sylhet. Flowing from the north Khasi mountains, the river Dauki enters Bangladesh under the name ‘Piyain’, along the bank of which lies the spectacular Jaflong. Visitors can hire boats to go to the Zero Point and see the beautiful hanging bridge over the Dauki. Just beside Nakshiapunji is Jaflong Tea Garden which is a top tourist attraction.
                                <br><br>
                                It situated 62 km away from the Sylhet city.
                              </p>
														</div>
													</div>
												</div>
